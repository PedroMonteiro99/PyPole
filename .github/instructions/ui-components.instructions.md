...
**See also:** [tailwind-styling.instructions.md](.github/instructions/tailwind-styling.instructions.md), [nextjs.instructions.md](.github/instructions/nextjs.instructions.md)
