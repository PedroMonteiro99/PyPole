...
- Use Tailwind CSS for layout and spacing, following the project's [tailwind-styling.instructions.md](.github/instructions/tailwind-styling.instructions.md)
...
- Follow the project's code style, React, and Next.js best practices [nextjs.instructions.md](.github/instructions/nextjs.instructions.md).
